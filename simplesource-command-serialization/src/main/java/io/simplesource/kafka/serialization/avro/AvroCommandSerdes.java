...
public final class AvroCommandSerdes<K, C> implements CommandSerdes<K, C> {
    ...
    public AvroCommandSerdes(
        ...
        crq = GenericSerde.of(valueSerde,
                ...
                s -> AvroSerdes.CommandRequestAvroHelper.fromGenericRecord(s).map2(x -> keyMapper.fromGeneric(x), x -> commandMapper.fromGeneric(x)));
        ...
        crp = GenericSerde.of(valueSerde,
                v -> AvroSerdes.CommandResponseAvroHelper.toCommandResponse(v, aggregateSchema),
