...
public final class UserAvroMappers {
    ...
    public static final GenericMapper<Optional<User>, GenericRecord> aggregateMapper = GenericMapper.of(
            maybeUser -> {
    ...
    public static final GenericMapper<UserEvent, GenericRecord> eventMapper = GenericMapper.of(
            value ->{
    ...
    public static final GenericMapper<UserCommand, GenericRecord> commandMapper = GenericMapper.of(
            value -> {
    ...
    public static final GenericMapper<UserKey, GenericRecord> keyMapper = GenericMapper.of(
            value -> UserId.newBuilder()
                    .setId(value.id())
                    .build(),
            serialized -> {
